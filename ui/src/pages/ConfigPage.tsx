...
import { useWorkspaceStore, AVAILABLE_WIDGETS } from '../stores/workspaceStore';
              ...
              {AVAILABLE_WIDGETS.map((widget) => (
                <label
                  ...
                  className={`
                    ...
                    ${hasWidget(selectedWorkspaceId, widget.type)
                ...
                >
                  <input
                    type="checkbox"
                    checked={hasWidget(selectedWorkspaceId, widget.type)}
                    onChange={() => toggleWidget(selectedWorkspaceId, widget.type)}
